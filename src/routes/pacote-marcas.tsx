...
export const Route = createFileRoute("/pacote-marcas")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "1h de estúdio, fotografia, edição e making-of por R$ 350 por marca." },
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        description: "Sessão fotográfica de 1h para marcas e brechós no estúdio Mambaia, com fotografia, edição e making-of.",
        brand: { "@type": "Brand", name: "Mambaia" },
        image: "https://mambaiabh.com.br/__l5e/assets-v1/bfe6eb16-e7c8-4f7d-be7b-b584a011b868/mambaia-estudio-4.jpg",
        offers: { "@type": "Offer", price: "350.00", priceCurrency: "BRL", availability: "https://schema.org/InStock", url: "https://mambaiabh.com.br/pacote-marcas" },
      }),
    }],
  }),
